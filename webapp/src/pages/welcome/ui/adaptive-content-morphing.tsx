...
const ADAPTIVE_FEATURES: AdaptiveFeature[] = [
  {
    ...
    present: {
      ...
      description:
        "Imaginez un instant : les données de vos 500 élèves sont analysées par des algorithmes étrangers, sans votre contrôle. C'est la réalité actuelle.",
      icon: Shield,
      color: "text-blue-600",
    ...
    past: {
      ...
      description:
        "Avec Google Workspace, vos données transitent par des serveurs US. Avec une solution souveraine, elles restent en France.",
    ...
    future: {
      ...
      description:
        "Migrez vers Keycloak + hébergement OVH. Open-source, français, certifié.",
      action:
        "1. Audit de vos données actuelles\n2. Installation Keycloak\n3. Migration progressive",
  ...
  },
  {
    ...
    present: {
      ...
      description:
        "Votre établissement dépend de Microsoft/Google pour tout : emails, documents, stockage. Si demain ils changent de prix ou de politique ?",
      icon: Server,
    ...
    past: {
      title: " Le coût caché",
      description:
        "Microsoft 365 : 10€/utilisateur/mois. Pour 500 comptes = 60 000€/an. Sur 5 ans : 300 000€ perdus.",
    ...
    future: {
      ...
      description:
        "Nextcloud + OnlyOffice auto-hébergés. Vous gardez le contrôle, les économies, les données.",
      action:
        "1. Serveur dédié OVH (100€/mois)\n2. Installation Nextcloud\n3. Formation équipe",
  ...
  },
  {
    ...
    present: {
      ...
      description:
        "Chaque élève utilise son compte Google pour se connecter. Pratique ? Oui. Mais Google collecte tout : recherches, connexions, habitudes.",
      icon: Key,
    ...
    past: {
      ...
      description:
        "Google SSO collecte l'activité de navigation, localisation, historique de connexion. RGPD = zone grise.",
      metric:
        "73% des écoles françaises utilisent Google malgré les alertes CNIL",
      risk: "Amendes RGPD : jusqu'à 20M€ ou 4% du CA annuel",
    },
    future: {
      title: " Authentification éthique",
      description:
        "Keycloak open-source : SSO sécurisé, aucune collecte, conforme RGPD nativement.",
      action:
  ...
  },
  {
    ...
    present: {
      ...
      description:
        "Vos documents pédagogiques, dossiers élèves, données RH sont sur OneDrive ou Google Drive. Hébergés où ? Vous ne savez pas vraiment.",
      icon: Database,
    ...
    past: {
      ...
      description:
        "Google Drive : serveurs multi-zones (US, EU, Asie). Microsoft : principalement US avec réplication.",
    ...
    future: {
      ...
      description:
        "Serveur NAS local + backup cloud français (Scaleway, OVH). Vitesse + sécurité + souveraineté.",
      action:
  ...
  },
  {
    ...
    present: {
      ...
      description:
        "Logiciels propriétaires = boîte noire. Vous ne savez pas ce qu'ils font de vos données ni comment ils fonctionnent vraiment.",
      icon: Eye,
      color: "text-pink-600",
    ...
    past: {
      ...
      description:
        "Windows 11 : télémétrie activée par défaut, collecte données d'usage, diagnostics envoyés à Microsoft.",
      metric:
        "95% des logiciels scolaires sont propriétaires et non-auditables",
      risk: "Failles de sécurité inconnues, backdoors potentielles",
    },
    future: {
      title: " Open-source auditable",
      description:
        "Linux + logiciels FLOSS : code source consultable, audits communautaires, sécurité prouvée.",
      action:
        "1. Migration progressive vers Linux\n2. Formation enseignants\n3. Accompagnement technique",
  ...
  },
  {
    ...
    present: {
      ...
      description:
        "Google Classroom, Teams, Zoom... Ces outils dominent l'éducation. Mais il existe des alternatives tout aussi performantes, éthiques et françaises.",
      icon: Cloud,
      color: "text-cyan-600",
    ...
    past: {
      ...
      description:
        "Zoom = serveurs US + failles de sécurité. Jitsi = open-source européen, même qualité, zéro tracking.",
    ...
    future: {
      ...
      description:
        "Tchap (messagerie), Jitsi (visio), Moodle (LMS), BigBlueButton (classe virtuelle). Tout existe déjà.",
      action:
        "1. Diagnostic de vos outils actuels\n2. Identification des équivalents\n3. Migration outil par outil",
        ...
        >
          {temporalState === "present" && !isReturningUser && (
            <p className="text-sm text-gray-600 dark:text-gray-400">
              💡 <strong>Nouveau ici ?</strong> Prends ton temps pour explorer.
              Quand tu seras prêt, passe en mode <strong>Passé</strong> pour
              voir les chiffres.
            </p>
          )}
          {temporalState === "past" && (
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Les données te parlent ? Passe en mode <strong>Futur</strong> pour
              voir le plan d'action concret.
            </p>
          )}
          {temporalState === "future" && (
            <p className="text-sm text-gray-600 dark:text-gray-400">
              🚀 Prêt à agir ? Le diagnostic te donnera un plan personnalisé
